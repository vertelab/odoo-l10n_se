...
odoo.define("mis_builder.widget.tax.report", function (require) {
    "use strict";
    ...
    var MisReportWidget = AbstractField.extend({
        ...
        willStart: function () {
            ...
            var self = this;
            var context = self.get_context();
            // Fix for empty value. This widget is used on the create page for Momsdeklaration. So the widget tries to run on an empty report.mis id since that hasen't been created yet.
            //This ends the function early if the id is empty
    ...
    core.form_widget_registry.add("mis_report_widget.tax.report", MisReportWidget);
