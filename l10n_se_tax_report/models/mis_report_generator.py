...
class account_vat_declaration(models.Model):
    ...
    # ~ @api.onchange('accounting_method','accounting_yearend')
    # ~ def not_implemented_yet(self):
            # ~ raise Warning("accounting method and accounting year end are not implemented yet, sorry")
    
    # ~ @api.onchange('period_start', 'period_stop', 'target_move','accounting_method','accounting_yearend','name')
    @api.onchange('period_start', 'period_stop', 'target_move','name')
    def _vat(self):
        # ~ 'accounting_method','accounting_method' don't do anything in this function since mis builder has no idea about accounting methods, i need to add it to mis_templates at some point. 
         ...
         for decl in self:
             if decl.target_move == "draft":
                raise Warning("Draft Target moves not implemented yet, sorry")
...
# ~ class account_move(models.Model): WAT?
