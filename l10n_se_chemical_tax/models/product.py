...
class ProductCategory(models.Model):
    ...
    # elkretsen_miljoavgift = fields.Float(string="elkretsen_miljoavgift", help="environmental fee for products in
    # this category")
...
class ProductProduct(models.Model):
    ...
    chemical_tax = fields.Float(string="Chemical tax", help="Computed chemical tax", compute="_chemical_compute",
                                store=True)
