...
# ~ class ResConfigSettings(models.TransientModel):
    ...
    # ~ payment_account_type_ids = fields.Many2many(comodel_name='account.account.type', relation='payment_account', string='Payment Accounts', help='Accounts types should include in payment')
    ...
    # ~ nixpayment_account_type_ids = fields.Many2many(comodel_name='account.account.type', relation='payment_account', string='Payment Accounts', help='Accounts types should be excluded in payments')
    ...
    # ~ def get_values(self):
        ...
        #[('reconciled', '=', False), ('company_id', '=', 1), ('blocked', '!=', True), '|', ('date_maturity', '<=', False), ('date_maturity', '=', False), ('credit', '>', 0), ('account_id.internal_type', 'in', ['payable', 'receivable'])] 
