...
class archive_config_installer(osv.osv_memory):
    ...
    _columns = {
        ...
        'linkRA': fields.char('Arkivering av räkenskaper', size=128,
                              help='Bokföringsnämnden har i denna vägledning samlat bokföringslagens bestämmelser och nämndens allmänna råd om räkenskapsinformation och dess arkivering (BFNAR 2000:5), kommentarer till dessa samt exempel på hur redovisning kan se ut.',
                              readonly=True),
        'linkFaqAR': fields.char('Faq anläggningsregister', size=128,
                                 help='Uttalande om anläggningsregister. Vem är skyldig att upprätta anläggningsregister',
                                 readonly=True),
        'linkFAB': fields.char('Enksilda näringsidkare som upprättar förenklat årsbokslut', size=128,
                               help='Bokföringsnämnden (BFN) har i denna vägledning samlat de redovisningsregler som gäller för de flesta enskilda näringsverksamheter. Fysiska personer som upprättar ett förenklat årsbokslut enligt 6 kap. bokföringslagen (1999:1078) ska tillämpa reglerna i vägledningen. Ett sådant får upprättas om nettoomsättningen i företaget normalt uppgår till högst tre miljoner kronor.',
                               readonly=True),
        'linkAnl': fields.char('Vägledning materiella anläggningstillgångar', size=128,
                               help='Bokföringsnämnden (BFN) har i sina allmänna råd om redovisning av materiella anläggningstillgångar (BFNAR 2001:3) angett hur Redovisningsrådets rekommendation Materiella anläggningstillgångar (RR 12) ska tillämpas i näringsdrivande icke-noterade företag1 som inte valt att tillämpa RR 12.',
                               readonly=True),
        'linkVer': fields.char('Vägledning verifikat', size=128,
                               help='Bokföringsnämnden har i denna vägledning samlat bokföringslagens bestämmelser och nämndens allmänna råd om verifikationer (BFNAR 2000:6)',
                               readonly=True),
        'link28316': fields.char('Anvisningar enskild näringsidkare', size=128,
                                 help='Deklarationsanvisningar för enskilda näringsidkare 2012', readonly=True),
        'linkBFN': fields.char('Att föra bok (BFN)', size=128, help='En handledning i bokföring från bokföringsnämnden',
                               readonly=True),
