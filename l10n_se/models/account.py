...
class AccountChartTemplate(models.Model):
    ...
    def _load(self, sale_tax_rate, purchase_tax_rate, company):
            ...
            if self.name in ('K1 - Mindre verksamheter',
                             'K2 - Små till medelstora verksamheter',
                             'K3 - Medelstora till större verksamheter',
                             'K4 - större verksamheter / publika företag',
                             'Generel Konto Plan med dem gemensamma kontona',
                   ):
