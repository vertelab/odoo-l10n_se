...
ln = [
    ...
    {'t': 'R', 'f': u"Råvaror och förnödenheter",
    ...
    {'t': 'R', 'f': u"Förändring av lager av produkter i arbete, färdiga varor och pågående arbete för annans räkning",
     ...
     'k': [('code', '>=', u'4900'), ('code', '<=', u'4999'), ('code', 'not in',
                                                              ' [4910,4911,4912,4913,4914,4915,4916,4917,4918,4919,4920,4921,4922,4923,4924,4925,4926,4927,4928,4929,4930,4931,4960,4961,4962,4963,4964,4965,4966,4967,4968,4969,4980,4981,4982,4983,4984,4985,4986,4987,4988,4989]')]},
    {'t': 'R', 'f': u"Handelsvaror", 'b': "Årets inköp av handelsvaror +/- förändring av lagerposten ”Handelsvaror”.",
     'k': [('code', 'in',
            '[4960,4961,4962,4963,4964,4965,4966,4967,4968,4969,4980,4981,4982,4983,4984,4985,4986,4987,4988,4989]')]},
    {'t': 'R', 'f': u"Övriga externa kostnader",
    ...
    {'t': 'R', 'f': u"Av- och nedskrivningar av materiella och immateriella anläggningstillgångar", 'b': "",
     'k': [('code', '>=', u'7700'), ('code', '<=', u'7899'), ('code', 'not in',
                                                              ' [7740,7741,7742,7743,7744,7745,7746,7747,7748,7749,7790,7791,7792,7793,7794,7795,7796,7797,7798,7799]')]},
    {'t': 'R', 'f': u"Nedskrivningar av omsättningstillgångar utöver normala nedskrivningar",
     'b': u"Används mycket sällan. Ett exempel är om man gör ovanligt stora nedskrivningar av kundfordringar.", 'k': [(
                                                                                                                      'code',
                                                                                                                      'in',
                                                                                                                      '[7740,7741,7742,7743,7744,7745,7746,7747,7748,7749,7790,7791,7792,7793,7794,7795,7796,7797,7798,7799]')]},
    {'t': 'R', 'f': u"Övriga rörelsekostnader",
    ...
    {'t': 'R', 'f': u"Resultat från andelar i koncernföretag",
     ...
     'k': [('code', '>=', u'8000'), ('code', '<=', u'8099'), ('code', 'not in',
                                                              ' [8070,8071,8072,8073,8074,8075,8076,8077,8078,8079,8080,8081,8082,8083,8084,8085,8086,8087,8088,8089]')]},
    {'t': 'R', 'f': u"Nedskrivningar av finansiella anläggningstillgångar och kortfristiga placeringar",
    ...
    {'t': 'R', 'f': u"Resultat från andelar i intresseföretag och gemensamt styrda företag",
     ...
     'k': [('code', '>=', u'8100'), ('code', '<=', u'8199'), ('code', 'not in',
                                                              ' [8170,8171,8172,8173,8174,8175,8176,8177,8178,8179,8180,8181,8182,8183,8184,8185,8186,8187,8188,8189]')]},
    {'t': 'R', 'f': u"Resultat från övriga företag som det finns ett ägarintresse i",
    ...
    {'t': 'R', 'f': u"Resultat från övriga finansiella anläggningstillgångar",
    ...
    {'t': 'R', 'f': u"Övriga ränteintäkter och liknande resultatposter",
     ...
     'k': [('code', '>=', u'8300'), ('code', '<=', u'8399'), ('code', 'not in',
                                                              ' [8370,8371,8372,8373,8374,8375,8376,8377,8378,8379,8380,8381,8382,8383,8384,8385,8386,8387,8388,8389]')]},
    {'t': 'R', 'f': u"Räntekostnader och liknande resultatposter",
    ...
    {'t': 'R', 'f': u"Extraordinära intäkter",
     'b': "Används mycket sällan. Får inte användas för räkenskapsår som börjar 2016-01-01 eller senare.",
     'k': [('code', '=', '8710')]},
    {'t': 'R', 'f': u"Extraordinära kostnader",
     'b': "Används mycket sällan. Får inte användas för räkenskapsår som börjar 2016-01-01 eller senare.",
     'k': [('code', '=', '8750')]},
    {'t': 'R', 'f': u"Förändring av periodiseringsfonder", 'b': "",
    ...
    {'t': 'R', 'f': u"Övriga bokslutsdispositioner", 'b': "", 'k': [('code', 'in',
                                                                     '[8840,8841,8842,8843,8844,8845,8846,8847,8848,8849,8860,8861,8862,8863,8864,8865,8866,8867,8868,8869,8870,8871,8872,8873,8874,8875,8876,8877,8878,8879,8880,8881,8882,8883,8884,8885,8886,8887,8888,8889,8890,8891,8892,8893,8894,8895,8896,8897,8898,8899]')]},
    {'t': 'R', 'f': u"Förändring av överavskrivningar", 'b': "",
     'k': ['&', ('code', '>=', '8850'), ('code', '<=', '8859')]},
    {'t': 'R', 'f': u"Skatt på årets resultat",
    ...
    {'t': 'R', 'f': u"Övriga skatter", 'b': "Används sällan.",
     'k': ['&', ('code', '>=', '8980'), ('code', '<=', '8989')]},
    {'t': 'R', 'f': u"Resultat", 'b': "", 'k': [('code', 'in', '[8990,8991,8992,8993,8994,8995,8996,8997,8998,8999]')]},
    {'t': 'B', 'f': u"Koncessioner, patent, licenser, varumärken samt liknande rättigheter", 'b': "", 'k': [('code',
                                                                                                             'in',
                                                                                                             '[1080,1081,1082,1083,1084,1085,1086,1087,1089,1000,1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012,1013,1014,1015,1016,1017,1018,1019,1020,1021,1022,1023,1024,1025,1026,1027,1028,1029,1030,1031,1032,1033,1034,1035,1036,1037,1038,1039,1040,1041,1042,1043,1044,1045,1046,1047,1048,1049,1050,1051,1052,1053,1054,1055,1056,1057,1058,1059]')]},
    {'t': 'B', 'f': u"Hyresrätter och liknande rättigheter", 'b': "",
     'k': ['&', ('code', '>=', '1060'), ('code', '<=', '1069')]},
    {'t': 'B', 'f': u"Goodwill", 'b': "", 'k': ['&', ('code', '>=', '1070'), ('code', '<=', '1079')]},
    {'t': 'B', 'f': u"Förskott avseende immateriella anläggningstillgångar",
     'b': "Förskott i samband med förvärv, t.ex. handpenning och deposition.", 'k': [('code', '=', '1088')]},
    {'t': 'B', 'f': u"Byggnader och mark",
     'b': "Förutom byggnader och mark, även maskiner som är avsedda för byggnadens allmänna användning.",
     'k': [('code', '>=', u'1100'), ('code', '<=', u'1199'), ('code', 'not in',
                                                              ' [1120,1121,1122,1123,1124,1125,1126,1127,1128,1129,1180,1181,1182,1183,1184,1185,1186,1187,1188,1189]')]},
    {'t': 'B', 'f': u"Förbättringsutgifter på annans fastighet", 'b': "",
     'k': ['&', ('code', '>=', '1120'), ('code', '<=', '1129')]},
    {'t': 'B', 'f': u"Pågående nyanläggningar och förskott avseende materiella anläggningstillgångar", 'b': "", 'k': [(
                                                                                                                      'code',
                                                                                                                      'in',
                                                                                                                      '[1180,1181,1182,1183,1184,1185,1186,1187,1188,1189,1280,1281,1282,1283,1284,1285,1286,1287,1288,1289]')]},
    {'t': 'B', 'f': u"Maskiner och andra tekniska anläggningar",
     'b': "Maskiner och tekniska anläggningar avsedda för produktionen.",
     'k': ['&', ('code', '>=', '1210'), ('code', '<=', '1219')]},
    {'t': 'B', 'f': u"Inventarier, verktyg och installationer",
     'b': "Om du fyller i detta fält måste du även fylla i motsvarande not i sektionen 'Noter'.",
     'k': ['&', ('code', '>=', '1220'), ('code', '<=', '1279')]},
    {'t': 'B', 'f': u"Övriga materiella anläggningstillgångar",
     'b': "T.ex. djur som klassificerats som anläggningstillgång.",
     'k': ['&', ('code', '>=', '1290'), ('code', '<=', '1299')]},
    {'t': 'B', 'f': u"Andelar i koncernföretag", 'b': "Aktier och andelar i koncernföretag.",
     'k': ['&', ('code', '>=', '1310'), ('code', '<=', '1319')]},
    {'t': 'B', 'f': u"Fordringar hos koncernföretag",
     'b': u"Fordringar på koncernföretag som förfaller till betalning senare än 12 månader från balansdagen.",
     'k': ['&', ('code', '>=', '1320'), ('code', '<=', '1329')]},
    {'t': 'B', 'f': u"Andelar i intresseföretag och gemensamt styrda företag",
     'b': "Aktier och andelar i intresseföretag.",
     'k': [('code', '>=', u'1330'), ('code', '<=', u'1339'), ('code', 'not in', ' [1336,1337]')]},
    {'t': 'B', 'f': u"Ägarintressen i övriga företag",
     'b': "Aktier och andelar i övriga företag som det redovisningskyldiga företaget har ett ägarintresse i.",
     'k': ['&', ('code', '>=', '1336'), ('code', '<=', '1337')]},
    {'t': 'B', 'f': u"Fordringar hos intresseföretag och gemensamt styrda företag",
    ...
    {'t': 'B', 'f': u"Fordringar hos övriga företag som det finns ett ägarintresse i",
    ...
    {'t': 'B', 'f': u"Råvaror och förnödenheter",
     ...
     'k': [('code', 'in',
            '[1410,1411,1412,1413,1414,1415,1416,1417,1418,1419,1420,1421,1422,1423,1424,1425,1426,1427,1428,1429,1430,1431,1438]')]},
    {'t': 'B', 'f': u"Varor under tillverkning", 'b': "Lager av varor där tillverkning har påbörjats.",
     'k': [('code', '>=', u'1432'), ('code', '<=', u'1449'), ('code', 'not in', '[1438]')]},
    {'t': 'B', 'f': u"Färdiga varor och handelsvaror",
    ...
    {'t': 'B', 'f': u"Pågående arbete för annans räkning",
     'b': "Om du fyller i detta fält måste du även fylla i motsvarande not i sektionen 'Noter'.",
     'k': ['&', ('code', '>=', '1470'), ('code', '<=', '1479')]},
    {'t': 'B', 'f': u"Förskott till leverantörer",
    ...
    {'t': 'B', 'f': u"Övriga lagertillgångar",
    ...
    {'t': 'B', 'f': u"Kundfordringar", 'b': "", 'k': [('code', 'in',
                                                       '[1500,1501,1502,1503,1504,1505,1506,1507,1508,1509,1510,1511,1512,1513,1514,1515,1516,1517,1518,1519,1520,1521,1522,1523,1524,1525,1526,1527,1528,1529,1530,1531,1532,1533,1534,1535,1536,1537,1538,1539,1540,1541,1542,1543,1544,1545,1546,1547,1548,1549,1550,1551,1552,1553,1554,1555,1556,1557,1558,1559,1580,1581,1582,1583,1584,1585,1586,1587,1588,1589]')]},
    {'t': 'B', 'f': u"Fordringar hos koncernföretag", 'b': u"Fordringar på koncernföretag, inklusive kundfordringar.",
     'k': [('code', 'in',
            '[1560,1561,1562,1563,1564,1565,1566,1567,1568,1569,1660,1661,1662,1663,1664,1665,1666,1667,1668,1669]')]},
    {'t': 'B', 'f': u"Fordringar hos intresseföretag och gemensamt styrda företag",
     'b': u"Fordringar på intresseföretag och gemensamt styrda företag, inklusive kundfordringar.", 'k': [('code', 'in',
                                                                                                           u'[1570,1571,1572,1574,1575,1576,1577,1578,1579,1670,1671,1672,1674,1675,1676,1677,1678,1679]')]},
    {'t': 'B', 'f': u"Fordringar hos övriga företag som det finns ett ägarintresse i",
     'b': u"Fordringar på övriga företag som det finns ett ägarintresse i, inklusive kundfordringar.",
     'k': ['|', ('code', '=', '1573'), ('code', '=', '1673')]},
    {'t': 'B', 'f': u"Övriga fordringar", 'b': u"T.ex. aktuella skattefordringar.", 'k': [('code', 'in',
    ...
    {'t': 'B', 'f': u"Upparbetad men ej fakturerad intäkt",
    ...
    {'t': 'B', 'f': u"Övriga kortfristiga placeringar",
     ...
     'k': [('code', '>=', u'1800'), ('code', '<=', u'1899'),
           ('code', 'not in', ' [1860,1861,1862,1863,1864,1865,1866,1867,1868,1869]')]},
    {'t': 'B', 'f': u"Andelar i koncernföretag",
    ...
    {'t': 'B', 'f': u"Aktiekapital", 'b': "", 'k': [('code', 'in',
    ...
    {'t': 'B', 'f': u"Årets resultat", 'b': "", 'k': [('code', 'in', '[2067,2068,2069,2095,2099]')]},
    {'t': 'B', 'f': u"Ej registrerat aktiekapital",
     'b': "Beslutad ökning av aktiekapitalet genom fond- eller nyemission.", 'k': [('code', '=', '2082')]},
    ...
    {'t': 'B', 'f': u"Övrigt fritt eget kapital", 'b': "",
     'k': ['|', '|', ('code', '=', '2092'), ('code', '=', '2094'), ('code', '=', '2096')]},
    {'t': 'B', 'f': u"Aktieägartillskott",
    ...
    {'t': 'B', 'f': u"Ackumulerade överavskrivningar", 'b': "",
     'k': ['&', ('code', '>=', '2150'), ('code', '<=', '2159')]},
    {'t': 'B', 'f': u"Övriga obeskattade reserver", 'b': "",
    ...
    {'t': 'B',
     ...
     'b': "Åtaganden för pensioner enligt tryggandelagen.", 'k': ['&', ('code', '>=', '2210'), ('code', '<=', '2219')]},
    {'t': 'B', 'f': u"Övriga avsättningar", 'b': "Andra avsättningar än för pensioner, t.ex. garantiåtaganden.", 'k': [(
                                                                                                                       'code',
                                                                                                                       'in',
    ...
    {'t': 'B', 'f': u"Övriga avsättningar för pensioner och liknande förpliktelser",
    ...
    {'t': 'B', 'f': u"Övriga skulder till kreditinstitut", 'b': "",
     'k': ['&', ('code', '>=', '2340'), ('code', '<=', '2359')]},
    {'t': 'B', 'f': u"Skulder till koncernföretag", 'b': "",
     'k': ['&', ('code', '>=', '2360'), ('code', '<=', '2369')]},
    {'t': 'B', 'f': u"Skulder till intresseföretag och gemensamt styrda företag", 'b': "",
     'k': [('code', 'in', u'[2370,2371,2372,2373,2374,2375,2376,2377,2378,2379]')]},
    {'t': 'B', 'f': u"Skulder till övriga företag som det finns ett ägarintresse i", 'b': "",
     'k': [('code', '=', '2373')]},
...
for l in ln:
    ...
    if u'Övriga kortfristiga placeringar' in l.get('f') or u'Färdiga varor och handelsvaror' in l.get(
            'f') or u'Varor under tillverkning' in l.get('f') or u'Pågående arbete för annans räkning' in l.get('f'):
        ut = 'account.data_account_type_current_assets'
    if u'Övriga lagertillgångar' in l.get(
            'f') or u'Koncessioner, patent, licenser, varumärken samt liknande rättigheter' in l.get(
            'f') or u'Hyresrätter och liknande rättigheter' in l.get('f') or 'Goodwill' in l.get(
            'f') or u"Andelar i koncernföretag" in l.get('f') or u'Andelar i intresse' in l['f'] or u'intressen' in l[
        'f'] or u'Andra långfristiga värdepappersinnehav' in l['f'] or u'Obligationslån' in l[
        'f'] or u'Förbättringsutgifter på annans fastighet' in l['f']:
        ut = 'account.data_account_type_non_current_assets'
    if 'Inventarier' in l.get('f') or 'Maskiner' in l.get('f') or 'Byggnader och mark' in l.get(
            'f') or u'Övriga materiella anläggningstillgångar' in l.get('f'):
    ...
    if u'Lån till delägare eller närstående' in l.get('f') or u'Tecknat men ej inbetalat kapital' in l.get(
            'f') or u'Fordringar hos intresseföretag' in l.get(
            'f') or u'Fordringar hos övriga företag som det finns ett ägarintresse i' in l.get(
            'f') or u'Andra långfristiga fordringar' in l.get('f'):
    ...
    if u'Skatteskulder' in l.get('f') or u'Uppskjuten skattefordran' in l.get('f'):
        ut = 'account.data_account_type_current_liabilities'
    if u'Ackumulerade överavskrivningar' in l.get(
            'f') or u'Avsättningar för pensioner och liknande förpliktelser' in l.get(
            'f') or u'Övriga avsättningar' in l.get('f') or u'Skulder till koncernföretag' in l.get(
            'f') or u'Skulder till övriga företag som det finns ett ägarintresse i' in l.get(
            'f') or u'Skulder till intresseföretag och gemensamt styrda företag' in l.get(
            'f') or u'Övriga skulder' in l.get('f'):
        ut = 'account.data_account_type_non_current_liabilities'

    if u'Leverantörsskulder' in l.get('f') or u'Checkräkningskredit' in l.get('f') or u'Växelskulder' in l.get(
            'f') or u'Upplupna kostnader och förutbetalda intäkter' in l.get('f') or u'Övriga fordringar' in l.get(
            'f') or u'Skattefordringar' in l.get('f') or u'Upparbetad men ej fakturerad intäkt' in l.get('f'):
        ut = 'account.data_account_type_payable'

    if u'Förskott' in l['f'] or u'förskott' in l['f'] or u'Förutbetalda' in l[
        'f'] or u'Fakturerad men ej upparbetad intäkt' in l['f']:
    ...
    if 'Aktiekapital' in l.get('f') or u'Övrigt bundet kapita' in l.get('f') or u'Övrigt bundet kapita' in l.get(
            'f') or u'Balanserat resultat' in l.get('f') or u'Övrigt fritt eget kapital' in l.get(
            'f') or u'Ej registrerat aktiekapital' in l.get('f') or u'Uppskrivningsfond' in l.get(
            'f') or u'Reservfond' in l.get('f') or u'Aktieägartillskott' in l.get('f') or u'Överkursfond' in l.get(
            'f') or u'Övriga bokslutsdispositioner' in l.get('f') or u'Resultat' in l.get(
            'f') or u'Årets resultat' in l.get('f'):
    ...
    if u'Extraordinära intäkter' in l.get('f') or u'Erhållna koncernbidrag' in l.get('f') or u'Resultat från ' in l.get(
            'f') or u'Övriga ränteintäkter' in l.get('f'):
        ut = 'account.data_account_type_other_income'
    if u'Aktiverat arbete för egen räkning' in l.get('f') or u'Råvaror och förnödenheter' in l.get(
            'f') or u'Handelsvaror' in l.get('f') or u'Förändring av lager av produkter i arbete' in l.get(
            'f') or u'Av- och nedskrivningar' in l.get('f') or u'Nedskrivningar' in l.get(
            'f') or u'Övriga rörelsekostnader' in l.get('f'):
        ut = 'account.data_account_type_direct_costs'
    if u'Övriga externa kostnader' in l.get('f') or u'Personalkostnader' in l.get('f') or u'Räntekostnader' in l.get(
            'f') or u'Lämnade koncernbidrag' in l.get('f') or u'Förändring av överavskrivningar' in l.get('f'):
    ...
    if l.get('k')[0] == '&':
        ...
        l['k'] = ('code', 'in', li)
        print_utf8(f,
                   {'t': l.get('t'), 'f': l.get('f').encode('utf-8'), 'b': l.get('b').encode('utf-8'), 'k': li, 'd': d,
                    'ut': ut})
    elif l.get('k')[0] == '|':
        li = []
        for i in l.get('k'):
