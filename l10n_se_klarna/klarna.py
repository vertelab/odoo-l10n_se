...
class KlarnaTransaktionsrapportType(object):
    """Parser for Klarna Kontohändelser import files."""
    ...
    def parse(self):
        """Parse Klarna transaktionsrapport bank statement file contents type 1."""
        ...
        self.current_statement.statement_id = 'Klarna %s' % self.data.cell(3,2).value
        self.current_statement.start_balance = 0.0
        for t in KlarnaIterator(self.data, header_row=16):
