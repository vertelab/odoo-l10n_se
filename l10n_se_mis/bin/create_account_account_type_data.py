...
def read_sheet(sheet=None, element_name=0, title=0, documentation=0, account_type=0, main_type=[], report_type='',
               nix=[], lst=None):
    mtype = ''
...
read_sheet(resultatrakning, r_element_name, r_title, r_documentation, r_account_type, r_main_type, 'r', r_element_nix,
           r_lst)
read_sheet(balansrakning, b_element_name, b_title, b_documentation, b_account_type, b_main_type, 'b', b_element_nix,
           b_lst)
    ...
    def parse_xml(sheet_list):
        ...
        for lst in sheet_list:
            for l in lst:
                ...
                field_account_range = ET.SubElement(record, "field", name="account_range").text = str(
                    l.get('account_range'))
