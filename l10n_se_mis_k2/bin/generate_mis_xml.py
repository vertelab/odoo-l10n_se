#!/usr/bin/env python3
"""
Generator: Läser K2 AB-taxonomi Excel och genererar MIS XML datafiler.
...
EXCEL_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)),
                          'k2-ab-arsredovisning-2024-09-12_rev20250312_sv.xlsx')
...
SHEETS = [
    ...
    },
    {
        ...
        'report_id': 'report_br_forkortad_k2',
    ...
    },
    {
        ...
        'report_id': 'report_rr_kostnadsslag_k2',
    ...
    },
    {
        ...
        'report_id': 'report_rr_kostnadsslag_forkortad_k2',
    ...
    },
    {
        ...
        'report_id': 'report_kf_indirekt_k2',
