...
class NordbankenTransaktionsrapport(object):
    """Parser for Nordbanken Transaktions import files (CSV)."""
    ...
    def parse(self):
        """Parse nordbanken bank statement file contents."""
        ...
        return NordbankenIterator(self.data)
        
        
class account(object):
    pass

class NordbankenIterator(object):
