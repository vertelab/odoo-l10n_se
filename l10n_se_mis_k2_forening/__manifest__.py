...
{
    'name': 'l10n_se: Swedish MIS-reports K2 (Ekonomisk förening)',
    'version': '1.0',
    'summary': 'Swedish MIS-reports for Ekonomisk förening enligt K2 (BFNAR 2016:10)',
    'category': 'Accounting/Localizations',
    'description': """
        K2-variant av svenska MIS-rapporter för ekonomisk förening.
        Baserad på l10n_se_mis men anpassad för K2-regelverket (BFNAR 2016:10).
    """,
    'author': 'Vertel AB',
    'website': 'https://vertel.se/apps/odoo-l10n_se/l10n_se_mis_k2_forening',
    'license': 'AGPL-3',
    'contributor': '',
