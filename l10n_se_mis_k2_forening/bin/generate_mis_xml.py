#!/usr/bin/env python3
"""
Generator: Läser K2 Förening-taxonomi Excel och genererar MIS XML datafiler.
...
EXCEL_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)),
                          'k2-ekfor-arsredovisning-2024-09-12_rev20250312_sv.xlsx')
...
SHEETS = [
    {
        ...
        'sheet': 'Balansräkning',
        'report_id': 'report_br_forening_k2',
    ...
    },
    {
        ...
        'report_id': 'report_br_forening_forkortad_k2',
    ...
    },
    {
        ...
        'report_id': 'report_rr_forening_kostnadsslag_k2',
    ...
    },
    {
        ...
        'report_id': 'report_rr_forening_kostnadsslag_forkortad_k2',
    ...
    },
    {
        ...
        'report_id': 'report_kf_forening_indirekt_k2',
